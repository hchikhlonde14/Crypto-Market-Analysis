...
End-to-end data science project analyzing cryptocurrency market data to identify investment opportunities and predict coin value categories.

**Business Problem:**

> Which cryptocurrencies offer the best investment opportunities based on market data and historical performance?
...
- 5 pages × 250 coins = 1,250 records
...
- Row-level security (RLS), synced slicers
- AI visual
...
1. 2025–2026 is the strongest bull market ever recorded
2. Bitcoin dominates with a $1.27T market cap
3. 99% of coins are priced under $5,000
4. Most coins move ±5% daily
5. Market cap strongly correlates with trading volume
...
### 1. Clone Repository
```bash
git clone https://github.com/[username]/crypto-analytics
cd crypto-analytics
```
...
### 5. Open Dashboard
Open `dashboard.pbix` in Power BI Desktop and refresh the data connections.

---

## 📸 Dashboard Screenshots

> **TODO:** Add screenshots here, for example:
